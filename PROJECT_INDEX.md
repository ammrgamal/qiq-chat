...
Generated: 2025-09-29T12:33:34.310Z
...
- See `docs/SCENARIOS.md` لملف سيناريوهات تشغيل مبسط واحترافي يوضح أهم تدفقات الاستخدام (تسجيل، عروض الأسعار، التاريخ، الاستنساخ، الأمان، AI، الفوترة المستقبلية).
